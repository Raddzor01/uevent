...
export const createCompany =
    (name, email, latitude, longitude) => async (dispatch) => {
        try {
            ...
            dispatch({ type: 'SET_MESSAGE', payload: 'Company created successfully' });
        } catch (error) {
...
export const getCompany = (id) => async (dispatch) => {
    try {
        ...
        dispatch({ type: 'SET_MESSAGE', payload: 'Company information received successfully' });
    } catch (error) {
        dispatch({ type: 'SET_MESSAGE', payload: error.response.data.message });
...
export const getCompanies = () => async (dispatch) => {
    try {
        ...
        dispatch({ type: 'SET_MESSAGE', payload: 'List of companies received successfully' });
    } catch (error) {
        dispatch({ type: 'SET_MESSAGE', payload: error.response.data.message });
...
export const getUserCompanies = (userId) => async (dispatch) => {
    try {
        ...
        dispatch({ type: 'SET_MESSAGE', payload: 'List of user companies received successfully' });
    } catch (error) {
        dispatch({ type: 'SET_MESSAGE', payload: error.response.data.message });
        console.error('Getting companies failed', error);
    }
...
export const deleteCompany = (id) => async (dispatch) => {
    try {
        ...
        dispatch({ type: 'SET_MESSAGE', payload: 'Company deleted successfully' });
    } catch (error) {
        dispatch({ type: 'SET_MESSAGE', payload: error.response.data.message });
        console.error('Creating company failed', error);
    }
...
export const updateCompany = (id, updatedFields) => async (dispatch) => {
    try {
        ...
        dispatch({ type: 'SET_MESSAGE', payload: 'Company updated successfully' });
    } catch (error) {
        dispatch({ type: 'SET_MESSAGE', payload: error.response.data.message });
...
export const createCompanyStripe = (id) => async (dispatch) => {
    try {
        ...
        dispatch({ type: 'SET_MESSAGE', payload: 'Company stripe account created successfully' });
...
export const getCompanyStripe = (id) => async (dispatch) => {
    try {
        ...
        dispatch({ type: 'SET_MESSAGE', payload: 'Company stripe account received successfully' });
    } catch (error) {
        dispatch({ type: 'SET_MESSAGE', payload: error.response.data.message });
        console.error('Updating company failed', error);
    }
